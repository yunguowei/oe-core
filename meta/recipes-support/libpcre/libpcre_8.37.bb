...
SRC_URI = "${SOURCEFORGE_MIRROR}/project/pcre/pcre/${PV}/pcre-${PV}.tar.bz2 \
           ...
           file://pcre-CVE-2015-8385.patch \
           file://pcre-CVE-2015-8386.patch \
           file://pcre-CVE-2015-8387.patch \
           file://pcre-CVE-2015-8388.patch \
           file://pcre-CVE-2015-8389.patch \
           file://pcre-CVE-2015-8390.patch \
           file://pcre-CVE-2015-8391.patch \
           file://pcre-fix-buffer-overflow.patch \
           file://pcre-CVE-2015-8392.patch \
           file://pcre-CVE-2015-8393.patch \
           file://pcre-CVE-2015-8394.patch \
           file://pcre-CVE-2015-8381-CVE-2015-8395.patch \
           file://libpcre-CVE-2016-3191.patch \
"
